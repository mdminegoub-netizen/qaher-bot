...
ADHKAR_TEXTS = [
    (
        ...
        "ردّديها بهدوء، واستحضري أن الله يسمع همّك قبل لسانك 🤍."
    ),
    (
        "🕊 *لتهدأ روحك يا حبيبة القلب:*\n\n"
        "قولي من قلبك:\n"
        "• يا حي يا قيوم برحمتك أستغيث، أصلح لي شأني كلَّه ولا تكلني إلى نفسي طرفة عين.\n"
        "• ربِّ إني مسّنيَ الضرّ وأنت أرحم الراحمين.\n\n"
        "ثم خذي نفسًا عميقًا، وتخيّلي أن كل همّ يخرج مع الزفير 🌬️."
    ),
    (
        "🕊 *حين يضيق صدرك يا غاليتي:*\n\n"
        "• سبحان الله، والحمد لله، ولا إله إلا الله، والله أكبر.\n"
        "• لا حول ولا قوة إلا بالله.\n\n"
        "كرّريها عشر مرات على الأقل، وستشعرين أن شيئًا في قلبك يلين، ولو قليلًا 🌸."
    ),
    (
        "🕊 *ذكر يملأ قلبك طمأنينة:*\n\n"
        "قال تعالى: ﴿أَلَا بِذِكْرِ اللَّهِ تَطْمَئِنُّ الْقُلُوبُ﴾.\n\n"
        "ردّدي:\n"
        "«اللهم أنزل السكينة على قلبي، واطرد عني همّي، واكتب لي نورًا ورضى في طريقي» 🤍."
    ),
    (
        "🕊 *لمن تشعر بثقل في قلبها:*\n\n"
        "• اللهم إن قلبي بين يديك، فثبّته على طاعتك، وأبعده عن المعصية، وقرّبه مما تحب.\n"
        "• اللهم اجعل تعافيّ تقرّبًا إليك، لا مجرد تغيير عادة.\n\n"
        "قوليها بيقين، فربُّك أكرم من أن يردّ قلبًا جاءه منكسرًا 🌧️➡️🌈."
    ),
]
...
def handle_notes(update: Update, context: CallbackContext):
    ...
    if not notes:
        update.message.reply_text(
            ...
            "«تعديل ملاحظة ✏️» و «حذف ملاحظة 🗑» داخل هذا القسم.",
